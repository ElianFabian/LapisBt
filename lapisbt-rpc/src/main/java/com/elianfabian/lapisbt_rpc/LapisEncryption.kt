...
public interface LapisEncryption {
	...
	public companion object {
		...
		public fun automatic(
			...
			return AutomaticEncryptionMarker(pinnedPublicKeyHash = pinnedPublicKeyHash, keyPair = keyPair)
		}
		...
		public fun automatic(
			...
			return AutomaticEncryptionMarker(pinnedPublicKeyHash = pinnedPublicKeyHash, keyPair = keyPair, factory = factory)
		}
		 ...
		 * @param info The info string for HKDF. Defaults to "LapisBT-RPC-v1".
		 */
