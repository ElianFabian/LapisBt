    ...
    process {
        switch ($PSCmdlet.ParameterSetName)
        {
            'IsEqualTo' {
                ...
                if (-not $isEqual)
                {
                    $strExpected = if ($IsEqualTo -is [System.Collections.IEnumerable] -and $IsEqualTo -isnot [string])
                    {
                        "@(" + ($IsEqualTo -join ', ') + ")"
                    }
                    else
                    ...
                    $strActual = if ($Actual -is [System.Collections.IEnumerable] -and $Actual -isnot [string])
                    {
                        "@(" + ($Actual -join ', ') + ")"
                    }
                    else
            ...
            'IsNotEqualTo' {
                ...
                if ($isEqual)
                {
                    $strExpected = if ($Expected -is [System.Collections.IEnumerable] -and $Expected -isnot [string])
                    {
                        "@(" + ($Expected -join ', ') + ")"
                    }
                    else
